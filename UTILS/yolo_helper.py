...
class YoloModel():
    ...
    def predict(self, frame, x_ranges=[(0.2,0.4), (0.4,0.6), (0.6,0.8),(0.8,1.0)], min_size=3600):
        ...
        if self.deck:
            ...
            #final output array will return 8 elements, each one either a 0 or 1 meaning if a card is present or not
            output_array = np.zeros(8, dtype=np.int32)
